...
{   
    	qer_editorimage textures/ad_content/q3_1x1.jpg
    	nopicmip
	{
		map textures/ad_content/q3_1x1.jpg
  	}
	{
		map $lightmap
	    	rgbGen identity
...
{
	qer_editorimage textures/ad_content/q3_2x1.jpg
	nopicmip
    	{
		map textures/ad_content/q3_2x1.jpg
  	}
	{
		map $lightmap
	    	rgbGen identity
...
{
	qer_editorimage textures/ad_content/q3_2x1_reverse.jpg
	nopicmip
    	{
		map textures/ad_content/q3_2x1_reverse.jpg
  	}
	{
		map $lightmap
	    	rgbGen identity
...
textures/map_sinister/item_decal_quad_sand_fixed_rotating
{
	...
	sort 6
	{
		map textures/map_sinister/item_decal_quad_sand_fixed.tga
