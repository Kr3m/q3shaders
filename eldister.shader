...
textures/map_sinister/sinister_sky_270
{
	qer_trans 0.60
	...
	q3map_sun 0.4 0.666667 0.8 88 270 75
...
textures/sfx/portal_new_static_cam
{
...
textures/map_sinister/item1decal1quad1sand1fixed1rotating
{
	qer_editorimage textures/map_sinister/item1decal1quad1sand1fixed.tga
...
textures/se_gothic/item_decal_hmg_sand_rotating
{
	qer_editorimage textures/se_gothic/item_decal_hmg_sand.tga
	surfaceparm nonsolid
	cull none
	nopicmip
	polygonOffset
...
textures/gothic_trim/chain3
{
	nopicmip
    	...
    	surfaceparm nonsolid
	{
		map textures/gothic_trim/chain3.tga
		alphaFunc GE128
		depthWrite
		rgbGen identity
	}
...
textures/map_sinister/orangerflare
{
	surfaceparm trans	
	surfaceparm nomarks	
	surfaceparm nonsolid
	...
	nopicmip
	{
		map textures/map_sinister/orangerflare.tga
		tcMod Scroll .3 0
		blendfunc add
	}
}
...
textures/ad_content/q32
{
	qer_editorimage textures/ad_content/q32.jpg
	nopicmip
    	{
		map textures/ad_content/q32.jpg
  	}
	{
		map $lightmap
	    	rgbGen identity
...
textures/ad_content/q31
{   
    	qer_editorimage textures/ad_content/q31.jpg
    	nopicmip
	{
		map textures/ad_content/q31.jpg
  	}
	{
		map $lightmap
	    	rgbGen identity
